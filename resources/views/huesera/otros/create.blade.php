...
<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Nuevo Ingreso Otro-Huesera</h3>
			@if (count($errors)>0)
			...
			{!!Form::open(array('url'=>'huesera/otros','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
            {{Form::token()}}
            <div class="form-group">
            	<label for="Tipo">Tipo</label>
				<input type="text" name="Tipo" required value="{{old('Tipo')}}" class="form-control" placeholder="Ingrese el tipo...">
            </div>
            <div class="form-group">
