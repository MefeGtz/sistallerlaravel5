...
<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Nuevo Ingreso de Aparato para huesera</h3>
			@if (count($errors)>0)
			...
			{!!Form::open(array('url'=>'huesera/aparatosh','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
            {{Form::token()}}
            <div class="form-group">
            	<label for="tipo">Tipo</label>
				<input type="text" name="tipo" required value="{{old('tipo')}}" list="listaaparatos"  class="form-control" placeholder="Seleccione o ingrese el tipo de aparato ">
